...
class Kite3d : public Kite {
	...
	protected:
		...
		const double close_ground = 10.0;
		const double closest_ground = 10.0;
		/* Generic wind type */
		Wind3d* wind;
...
/* Same as Kite3d_vrel but restarting from final conditions when episodes ends successfully*/
class Kite3d_cont : public Kite3d_vrel {
	public:
		Kite3d_cont(const param& params, Wind3d* wind, std::mt19937& generator) :
